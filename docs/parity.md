...
The latest uninterrupted serial all-target run passed 287 unit tests and 471
integration tests on macOS: 758 passed, no failures. A79 records this validation;
