...
The latest uninterrupted serial all-target run passed 277 unit tests and 447
integration tests on macOS: 724 passed, no failures. A73 records this validation;
